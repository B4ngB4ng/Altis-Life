...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\Cops\police_offroad.paa","cop"],
			["#(argb,8,8,3)color(0.6,0.3,0.01,1)","civ"],
			["textures\Cops\swat_offroad.paa","cop"]
		];
	};
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\Cops\police_suv.paa","cop"]
		];
	};
	...
	case "O_Heli_Light_02_unarmed_F":
	{
		...
		[
			...
			["#(argb,8,8,3)color(1,1,1,0.8)","med"],
			["\a3\air_f\Heli_Light_02\Data\heli_light_02_ext_civilian_co.paa","cop"]
		];
	};
	...
	case "B_MRAP_01_F":
	{
		...
		[
			...
			["textures\Cops\swat_hunter_1.PAA","cop"],
			["textures\Cops\swat_hunter_2.PAA","cop"]
		];
	};
